...
namespace EsriCo.ArcGisMaps.Maui.UI
{
  ...
  public partial class NavigationBarView : ContentView
  {
    ...
    private static void OnMapViewPropertyChanged(BindableObject bindable, object oldValue, object newValue)
    {
      ...
      if(newValue is MapView newMapView && panelView is not null)
      {
        ...
        else
        {
          ...
          {
            if(newMapView.Map is not null && e.PropertyName == nameof(newMapView.Map))
            {
              panelView.CheckMap(newMapView.Map);
            }
          };
    ...
    public void CheckMap(Mapping.Map map) => IsVisible = map != null;
    ...
    private static void OnZoomInButtonImageChanged(BindableObject bindable, object oldValue, object newValue)
    {
      ...
      if(newValue is null && navigationBarView is not null)
      {
    ...
    {
      if(MapView.Map is not null && MapView.Map.InitialViewpoint is not null)
      {
