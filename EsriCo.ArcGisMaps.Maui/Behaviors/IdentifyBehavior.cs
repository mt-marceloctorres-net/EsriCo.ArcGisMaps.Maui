...
namespace EsriCo.ArcGisMaps.Maui.Behaviors
{
  ...
  public class IdentifyBehavior : BehaviorBase<MapView>
  {
    ...
    protected override void OnAttachedTo(MapView bindable)
    {
      ...
      bindable.GeoViewTapped += GeoViewTappedEventHandler;
    }
    ...
    /// <param name="e"></param>
    private async void GeoViewTappedEventHandler(object? sender, GeoViewInputEventArgs e)
    {
            ...
            if(identifyGraphicOverlayResults != null)
            {
              identifyResults
                .GraphicsResults = (from r in identifyGraphicOverlayResults
                                    ...
                                    where g.Symbol is not TextSymbol && g.GraphicsOverlay != null &&
                                      GraphicsOverlays
                                        .Select(go => go.Id)
